...
if ( ! defined( 'WPTABLEEDITOR_VERSION' ) ) define( 'WPTABLEEDITOR_VERSION', '1.5.1' );
...
if ( ! class_exists( 'wptableeditor_main' ) ) {
	class wptableeditor_main {
		...
		public function xs_enqueue_scripts(){
			global $pagenow;
			if ( $pagenow === 'admin.php' && isset($_GET['page']) && in_array( $_GET['page'], array( 'wptableeditor' ) ) ) {
				wp_enqueue_style( 'xsbootstrap', WPTABLEEDITOR_VENDOR. 'bootstrap/css/bootstrap.min.css', array(), WPTABLEEDITOR_VERSION );
				wp_enqueue_style( 'xsstyle', WPTABLEEDITOR_ASSETS. 'css/style.css', array(), WPTABLEEDITOR_VERSION );
				wp_enqueue_style( 'xsadmin', WPTABLEEDITOR_ASSETS. 'css/admin.css', array(), WPTABLEEDITOR_VERSION );
				wp_enqueue_script( 'xsbootstrap', WPTABLEEDITOR_VENDOR. 'bootstrap/js/bootstrap.bundle.min.js', array(), WPTABLEEDITOR_VERSION );
				if($_GET['page'] === 'wptableeditor'){
					wp_enqueue_style( 'wptableeditor', WPTABLEEDITOR_VENDOR. 'datatables/datatables.min.css', array(), WPTABLEEDITOR_VERSION );
					wp_enqueue_script( 'wptableeditor', WPTABLEEDITOR_VENDOR. 'datatables/datatables.min.js', array(), WPTABLEEDITOR_VERSION );
					...
					if(isset($_GET['tab']) && isset($_GET['table_id'])){
						...
						if($tab === 'column'){
							...
							wp_enqueue_script( 'xscolumn', WPTABLEEDITOR_ASSETS. 'js/column.js', array(), WPTABLEEDITOR_VERSION );
							...
							wp_enqueue_script( 'xsmoment', WPTABLEEDITOR_VENDOR. 'moment/moment.min.js', array(), WPTABLEEDITOR_VERSION );
							wp_enqueue_script( 'xsaudio', WPTABLEEDITOR_ASSETS. 'js/soundmanager.js', array(), WPTABLEEDITOR_VERSION );
							$localize = wp_json_encode(wptableeditor_row::localize($table_id));
							wp_enqueue_script( 'xsrow', WPTABLEEDITOR_ASSETS. 'js/row.js', array(), WPTABLEEDITOR_VERSION );
							...
							wp_enqueue_script( 'xsimport', WPTABLEEDITOR_ASSETS. 'js/import.js', array(), WPTABLEEDITOR_VERSION );
						...
						wp_enqueue_script( 'xstable', WPTABLEEDITOR_ASSETS. 'js/table.js', array(), WPTABLEEDITOR_VERSION );
