...
if ( ! class_exists( 'wptableeditor_shortcode' ) ) {
	...
	class wptableeditor_shortcode {
		...
		function xs_enqueue_style(){
			if(!is_admin()){
				wp_register_style( 'xsdatatables', WPTABLEEDITOR_VENDOR. 'datatables/datatables.min.css', array(), WPTABLEEDITOR_VERSION );
				wp_register_style( 'xsstyle', WPTABLEEDITOR_ASSETS. 'css/style.css', array(), WPTABLEEDITOR_VERSION );
				wp_register_style( 'xsfront', WPTABLEEDITOR_ASSETS. 'css/front.css', array(), WPTABLEEDITOR_VERSION );
				wp_register_style( 'xstabs', WPTABLEEDITOR_ASSETS. 'css/tabs.css', array(), WPTABLEEDITOR_VERSION );
				wp_register_style( 'xsshortcode', false );
				wp_register_script( 'xsdatatables', WPTABLEEDITOR_VENDOR. 'datatables/datatables.min.js', array('jquery'), WPTABLEEDITOR_VERSION );
				wp_register_script( 'xsmoment', WPTABLEEDITOR_VENDOR. 'moment/moment.min.js', array(), WPTABLEEDITOR_VERSION );
				wp_register_script( 'xsshortcode', WPTABLEEDITOR_ASSETS. 'js/shortcode.js', array(), WPTABLEEDITOR_VERSION );
				wp_register_script( 'xstabs', WPTABLEEDITOR_ASSETS. 'js/tabs.js', array('jquery'), WPTABLEEDITOR_VERSION );
			}
		}
