...
Tags: Document Management,File Manager,Media Manager,document manager,project management,gutenberg,elementor
Requires at least: 5.5
Tested up to: 6.4.2
Stable tag: 4.70

Document, File & Media Manager. A Remote file sharing plugin to manage, share, track, group, distribute any type of document,file or media.

== Description ==
**Document, File & Media Manager plugin **

[youtube https://www.youtube.com/watch?v=CpxlSKASPCo]


Document, file and Media manager plugin, A Remote file & Media manager, maintain and control unlimited number of documents, records, files, media, videos and images. You can create unlimited folders and sub folders to share, organize, manage client, student & supplier documents and accounts, control individual documents, and select specific file sharing of documents all in an easy to manage online process.
...
* Two different template views! Table and list mode
* Built in Login/Registration System
* Ajax multi uploader
* Upload multiple files with one click
...
* Gutenberg and Elementor friendly!

** What do you get when upgrading? Check out this video! **

[youtube https://www.youtube.com/watch?v=OprPg5TgR9o]
...
* Woocommerce integration: purchase digital product right in the document manager
* Amazon s3 Integration available as an addon!
* Import Files to multiple users by uploading a zip
...
* Comments on folders and files
* Folder and file logging
* Remove branding
...
* Users upload documents,files media and  online to their own personal page
...
* Fixed sql injection issue found by Rafshanzani Suhada

= 4.58 =

* Add security measure to randomize the uploads folder for users that have not set a folder. (addresses wpscan security vuln)

= 4.55 =

* Added a native login/reg system built in with recaptcha

= 4.33 =

* Added some security fixes
* Built a brand new uploading process which uses ajax and now supports multi upload on one click.
...
* Fix revision for file shortcode
= 3.7.3 =
